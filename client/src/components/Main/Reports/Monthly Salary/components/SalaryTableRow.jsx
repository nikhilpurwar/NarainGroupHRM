...
const SalaryTableRow = memo(({ 
  ...
  return (
    <tr className="hover:bg-gray-50 transition">
      ...
      <td className="px-4 py-3 text-sm text-gray-900">₹{item.salary || '0'}</td>
      <td className="px-4 py-3 text-sm text-gray-900">₹{item.salaryPerDay?.toLocaleString() || '0'}</td>
      ...
      <td className="px-4 py-3 text-sm text-gray-900 text-center">{item.basicHours}</td>
      <td className="px-4 py-3 text-sm font-medium text-gray-900">₹{item.basicPay?.toLocaleString() || '0'}</td>
      <td className="px-4 py-3 text-sm text-gray-900 text-center">{item.otHours}</td>
      <td className="px-4 py-3 text-sm font-medium text-gray-900">₹{item.otPay?.toLocaleString() || '0'}</td>
      <td className="px-4 py-3 text-sm text-gray-900 text-center">{item.totalHours}</td>
