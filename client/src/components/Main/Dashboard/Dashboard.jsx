    ...
    <div className='flex flex-col gap-6 p-6'>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 ">
        {CardData1.map((card, index) => {
          return (
            <div key={card.title || index} className='card-hover flex justify-between items-center bg-gray-200 shadow-md p-4 rounded-lg'>
        ...
        <div className="card-hover flex gap-4 items-center bg-gray-200 shadow-md p-4 rounded-lg">
          <div className="flex items-center justify-center w-16 h-16 bg-gray-300 rounded-full">
